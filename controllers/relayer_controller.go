...
//+kubebuilder:rbac:groups=cosmos.nebula-labs.org,resources=relayers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cosmos.nebula-labs.org,resources=relayers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cosmos.nebula-labs.org,resources=relayers/finalizers,verbs=update
