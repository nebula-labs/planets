...
type NetSpec struct {
	...
	// Foo is an example field of Net. Edit net_types.go to remove/update
...
// Net is the Schema for the nets API
type Net struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   NetSpec   `json:"spec,omitempty"`
	Status NetStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// NetList contains a list of Net
type NetList struct {
	metav1.TypeMeta `json:",inline"`
